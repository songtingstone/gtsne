    ...
    def build_extensions(self):
        ...
        if sys.platform == "darwin":
            ...
            ext_module = Extension(
                name="st_gtsne",
                sources=[
                    "gtsne/includes/st_gtsne/quadtree.cpp",
                    "gtsne/includes/st_gtsne/gtsne.cpp",
                    "gtsne/st_gtsne.pyx",
                ],
                include_dirs=["gtsne/includes/st_gtsne/"],
            ...
            ext_module = Extension(
                ...
                include_dirs=["/usr/local/include", "gtsne/includes/st_gtsne/",],
...
setup(
    ...
    description="GTSNE algorithms",
    long_description=read_file("README.md"),
    long_description_content_type="text/markdown",
    license="Apache License, Version 2.0",
    maintainer="Songting Shi",
    maintainer_email="songtingstone@gmail.com",
    url="https://github.com/songtingstone/gtsne",
